<template>
    <div class="main-content">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shipindianbo/upload/shipinMuBan.xls"
                        >批量导入视频信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shipin','导入导出')"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="shipinPhoto"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.shipinPhoto">
                                <img :src="$base.url+scope.row.shipinPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="shipinVideo"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.shipinVideo">
                                <video :src="$base.url+scope.row.shipinVideo" width="100" height="100" controls="controls">
                                </video>
                            </div>
                            <div v-else>无视频</div>
                        </template>
		...
		<el-dialog title="统计报表" :visible.sync="chartVisiable2" width="80%">
		    <el-date-picker v-model="echartsDate2" type="year" placeholder="选择年"> </el-date-picker>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			chartDialog2() {
			    ...
			    let params = {
			        dateFormat :"%Y", //%Y-%m
			        riqi :getYearFormat(_this.echartsDate2),//年
			        // riqi :getMonthFormat(_this.echartsDate),//年月
			        thisTable : {//当前表
			            tableName :'shipin',//当前表表名,
